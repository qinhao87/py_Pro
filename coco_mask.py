...
def main(args):
    ...
    os.makedirs(os.path.join(args.input_dir, 'val2017_annotations'), exist_ok=True)
    ...
    for imgId in tqdm.tqdm(imgIds, ncols=100):
        ...
        if len(annIds) > 0:
            ...
            seg_output_path = os.path.join(args.input_dir, 'train2017_annotations',
...
def get_args():
    ...
    parser.add_argument("--input_dir", default="/home/hao/文档/coco2017/", type=str,
