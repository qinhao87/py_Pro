...
coco = COCO('/home/hao/文档/coco2017/annotations/instances_train2017_w.json',
            origin_img_dir='/home/hao/文档/coco2017/train2017')               # 完整的coco数据集的图片和标注的路径
coco.build('./mini_train2017', './mini_instances_train2017.json', 29568)  # 保存图片路径


coco = COCO('/home/hao/文档/coco2017/annotations/instances_val2017_w.json',
            origin_img_dir='/home/hao/文档/coco2017/val2017')                 # 完整的coco数据集的图片和标注的路径
